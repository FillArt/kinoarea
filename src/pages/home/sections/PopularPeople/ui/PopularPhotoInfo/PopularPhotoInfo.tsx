    ...
    return (
        <div className="group relative tablet:h-full phone:h-[321px] h-[179px] cursor-pointer">
            <div style={imgStyle}
                ...
                {!data?.profile_path &&
                    <div className="absolute bg-[#191E2E] rounded-[10px] left-0 top-0 w-full h-full flex flex-col justify-center items-center">
                        <Empty noText={true}/>
                    </div>
                }

                <span className="tabletLg:text-[15px] z-[9] text-[12px] text-decorTextColor">{place}</span>
                <div className="tabletLg:mx-[20px] z-[9] phone:mx-[15px] tabletLg:mb-[25px] mb-[12px] leading-tight">
